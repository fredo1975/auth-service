package fr.bluechipit.auth.service;
...
import fr.bluechipit.auth.service.model.repository.UserRepository;
@Service
public class JdbcUserDetailsService implements UserDetailsService{
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
    	...
    	Optional<fr.bluechipit.auth.service.model.object.User> possibleUser = credentialsRepository.findUserWithName(username);
